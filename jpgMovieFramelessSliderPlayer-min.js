...
jpgMoviePlayer.prototype.showLoadOnDemandButton = function(b) {
    ...
    if (a != null) {
        ...
        if (d != null) {
            var c = d.innerHTML;
            var f = a.offsetTop + Math.ceil((this.height - 100) / 2);
            var e = a.offsetLeft + Math.ceil((this.width - 100) / 2);
            c += '<DIV STYLE="position:absolute; top:' + f + "px; left:" + e + 'px;"><A HREF="#" onClick="jm_' + this.divName + ".loadFromUrl('" + b + '\'); return false;"><IMG SRC="http://www.jpgMovie.com/images/player/on_demand_play_triangle.png" WIDTH=100 HEIGHT=100 BORDER=0></A></DIV>';
            d.innerHTML = c
        }
    }
    if (this.divPlayButton == null) {
...
jpgMoviePlayer.prototype.getControlHtml_RegularSpeedAdjuster = function(a) {
    var b = "";
    b += '  <IMG ID="' + this.divName + '_speed_adjuster" SRC="' + a + '" WIDTH=120 HEIGHT=16 BORDER=0 usemap="#' + this.divName + '_speed_adjuster_map">';
    b += '  <MAP NAME="' + this.divName + '_speed_adjuster_map">';
    b += '  <AREA shape=rect coords="42,0,55,16" href="#" onClick="jm_' + this.divName + '.useSpeed(1); return false;">';
    b += '  <AREA shape=rect coords="58,0,71,16" href="#" onClick="jm_' + this.divName + '.useSpeed(2); return false;">';
    b += '  <AREA shape=rect coords="74,0,87,16" href="#" onClick="jm_' + this.divName + '.useSpeed(3); return false;">';
    b += '  <AREA shape=rect coords="90,0,103,16" href="#" onClick="jm_' + this.divName + '.useSpeed(4); return false;">';
    b += '  <AREA shape=rect coords="106,0,119,16" href="#" onClick="jm_' + this.divName + '.useSpeed(5); return false;">';
    b += "  </MAP>";
    return b
};
...
jpgMovieFramelessSliderPlayer.prototype.draw = function() {
    ...
    this.speed_adjusters[1].src = "http://www.JpgMovie.com/images/player/frameless/speed_adjuster_1.jpg";
    this.speed_adjusters[2] = new Image();
    this.speed_adjusters[2].src = "http://www.JpgMovie.com/images/player/frameless/speed_adjuster_2.jpg";
    this.speed_adjusters[3] = new Image();
    this.speed_adjusters[3].src = "http://www.JpgMovie.com/images/player/frameless/speed_adjuster_3.jpg";
    this.speed_adjusters[4] = new Image();
    this.speed_adjusters[4].src = "http://www.JpgMovie.com/images/player/frameless/speed_adjuster_4.jpg";
    this.speed_adjusters[5] = new Image();
    this.speed_adjusters[5].src = "http://www.JpgMovie.com/images/player/frameless/speed_adjuster_5.jpg";
    var a = "";
    ...
    a += '<DIV STYLE="border:2px solid #666699; width:' + this.playerWidth + "px; height:" + (this.playerHeight - 16) + 'px; background-color:#CCCCFF;">\n';
    ...
    a += '<DIV STYLE="margin:0px 0px 0px 0px; position:relative; padding:0; width:' + this.width + "px; height:" + this.height + 'px; background-color:transparent;">\n';
    if (this.bTargetEnabled) {
        a += '<A ID="' + this.divName + '_target" HREF="' + this.defaultTarget + '"><img src="' + this.img + '" width="' + this.width + '" height="' + this.height + '" ID="' + this.divName + '_screen" BORDER=0></A>\n'
    } else {
        a += '<img src="' + this.img + '" width="' + this.width + '" height="' + this.height + '" ID="' + this.divName + '_screen" BORDER=0>\n'
    }
    a += '<DIV ID="' + this.divName + '_play_button" STYLE="margin:3px 0px 3px 0px; padding:0; background-color:transparent; text-align:center;"></DIV>';
    var b = parseInt(((this.playerWidth - 109 - 136) / 2));
    a += '<DIV ID="' + this.divName + '_buffering" STYLE="text-align:center;"></DIV>';
    a += '<DIV STYLE="width:109px; margin:0px 0px 0px ' + b + 'px; float:left;">';
    a += '  <DIV ID="' + this.divName + '_frame_slider" STYLE="margin:5px 0px 5px 0px; width:109px; height:10px; background:url(http://www.JpgMovie.com/images/player/flexible/slider_bg.gif) no-repeat; text-align: left; display: none;"><DIV ID="' + this.divName + '_frame_slider_handle" class="handle" STYLE="width:16px; height:16px; background-color:transparent; cursor:move; display:none;"><IMG SRC="http://www.jpgmovie.com/images/player/flexible/slider_button_16_16.gif" WIDTH=16 HEIGHT=16 BORDER=0></DIV></DIV>';
    a += "</DIV>\n";
    a += '<DIV STYLE="width:120px; height:16px; margin:0px 0px 0px 20px; float:left">';
