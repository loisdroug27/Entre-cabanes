...
$foldertitrepage =  str_replace("_","/",$folder);
$foldertitremenu =  str_replace(array('_') , array('/<span style="color:#023CEB;">'),$folder);
?>



    <TITLE><?php echo $foldertitrepage ?></TITLE>
...
<header>
       ...
       <div class="titre"><?php echo $foldertitremenu ?></span> 
       </div>
